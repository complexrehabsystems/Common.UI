...
using APlatform = Xamarin.Forms.Platform.Android;
...
namespace Common.UI.Android.Renderers
{
	...
	internal class BorderDrawable : Drawable
	{
		...
		public bool IsDisposed(Java.Lang.Object obj)
		{
		...
		public override void Draw(Canvas canvas)
		{
			...
			if (_normalBitmap == null ||
				IsDisposed(_normalBitmap) == true ||
				IsDisposed(_pressedBitmap) == true ||
